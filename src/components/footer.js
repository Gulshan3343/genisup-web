...
function Footer() {
  return (
    <footer className="bg-dark text-white pt-120 pb-100 footerNext" style={{ paddingTop: '50px' }}>
            <div className="footer_container">
                <div className="row bg_black gy-50">
                    <div className="col-12 col-lg-3"><a className="d-block mb-30" href="index.html">
                            <img width="50%" src="Genisup logo.svg"/>
                        </a>
                        <p className="font-size-15 mb-35">
                            <strong>Genisup India Pvt. Ltd.</strong><br/> #236,TNHB Phase VII, Brindavan Hosur, 635109, Tamil Nadu, IN
                        </p>
                        ...
                        <p className="font-size-13 text-muted m-0">Copyright © 2022 - Genisup India Pvt. Ltd.
                    ...
                    <div className="col-12 col-lg-7">
                        <div className="footer-row gy-50">
                            <div className="col-6 col-md-4 pd-15">
