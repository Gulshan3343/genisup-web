  ...
  return (
    <nav>
        {/* <!-- <div className="container"> --> */}
            ...
            <label for="check" id="checkbtn" > <i><span className="material-symbols-outlined">
                menu
                </span></i></label>
            ...
            <ul>
                ...
                {/* <li><a href="/ai-products/ai-studio" id="learn-more__ai-studio-btn" className="contact_us">
                        Contact us <big>  </big>
                    </a></li> */}
            </ul>

            {/* <ul className="nav nav-gap-sm navbar-nav nav-social ms-auto ms-lg-70 me-30 me-lg-0 order-2 order-lg-3 align-items-center">
