  ...
  return (
    ...
    <div>
        ...
        <div className="pb-130">
            <div className="container">
                <hr className="mt-100 mb-60"/>
                <div className="row gy-40">
                    <div className="col-12 col-sm-6 col-lg-3 animated" data-show="startbox"
                        style={{transform: 'translateY(0px)', transitionduration: '500ms', opacity: '1'}}>
                        <div className="h1 m-0 text-accent-2">328</div>
                        <div className="h6 mb-15">Successful projects</div>
                        <p className="font-size-15 m-0 pe-20">You every can't thing seed subdue subdue light female.</p>
                    </div>
                    <div className="col-12 col-sm-6 col-lg-3 animated" data-show="startbox" data-show-delay="100"
                        style={{transform: 'translateY(0px)', transitionduration: '500ms', opacity: '1'}}>
                        <div className="h1 m-0 text-accent-2">10+</div>
                        <div className="h6 mb-15">Years of exeperience</div>
                        <p className="font-size-15 m-0 pe-20">Called a fly, behold seasons meat which stars bring fruit.</p>
                    </div>
                    <div className="col-12 col-sm-6 col-lg-3 animated" data-show="startbox" data-show-delay="200"
                        style={{transform: 'translateY(0px)', transitionduration: '500ms', opacity: '1'}}>
                        <div className="h1 m-0 text-accent-2">68%</div>
                        <div className="h6 mb-15">Cost savings</div>
                        <p className="font-size-15 m-0 pe-20">Image isn't that give appear made us you're yielding.</p>
                    </div>
                    <div className="col-12 col-sm-6 col-lg-3 animated" data-show="startbox" data-show-delay="300"
                        style={{transform: 'translateY(0px)', transitionduration: '500ms', opacity: '1'}}>
                        <div className="h1 m-0 text-accent-2">1k</div>
                        <div className="h6 mb-15">Email leads generated</div>
                        <p className="font-size-15 m-0 pe-20">Fruit deep first cattle set fourth without and day subdue.</p>
                    </div>
                </div>
            </div>
        </div>
